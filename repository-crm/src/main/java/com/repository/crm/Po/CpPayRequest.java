...
public class CpPayRequest {
	...
	private String residueBuyLength;
	
	private String consumeGiveLength;
	
	private String residueGiveLength;
	
	private String remarkUserUuid;	

	private String consumeBuyLength;
	...
	public String getRemarkUserUuid() {
		return remarkUserUuid;
	}

	public void setRemarkUserUuid(String remarkUserUuid) {
		this.remarkUserUuid = remarkUserUuid;
	}

	public String getConsumeBuyLength() {
		return consumeBuyLength;
	}

	public void setConsumeBuyLength(String consumeBuyLength) {
		this.consumeBuyLength = consumeBuyLength;
	}

	public String getResidueGiveLength() {
		return residueGiveLength;
	}

	public void setResidueGiveLength(String residueGiveLength) {
		this.residueGiveLength = residueGiveLength;
	}

	public String getResidueBuyLength() {
		return residueBuyLength;
	}

	public void setResidueBuyLength(String residueBuyLength) {
		this.residueBuyLength = residueBuyLength;
	}

	public String getConsumeGiveLength() {
		return consumeGiveLength;
	}

	public void setConsumeGiveLength(String consumeGiveLength) {
		this.consumeGiveLength = consumeGiveLength;
	}
