...
public class Leads {
    ...
    public String getIsGiveFree() {
        return isGiveFree;
    }

    public void setIsGiveFree(String isGiveFree) {
        this.isGiveFree = isGiveFree == null ? null : isGiveFree.trim();
    }
    ...
    public Boolean getTmkSignStatus() {
    ...
    public Date getTmkSignTime() {
        return tmkSignTime;
    }

    public void setTmkSignTime(Date tmkSignTime) {
        this.tmkSignTime = tmkSignTime;
    }
