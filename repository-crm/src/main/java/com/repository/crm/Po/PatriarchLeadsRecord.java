...
public class PatriarchLeadsRecord {
    private Integer id;

    private String patriarchLeadsRecordUuid;
    ...
    public String getPatriarchLeadsRecordUuid() {
        return patriarchLeadsRecordUuid;
    }

    public void setPatriarchLeadsRecordUuid(String patriarchLeadsRecordUuid) {
        this.patriarchLeadsRecordUuid = patriarchLeadsRecordUuid == null ? null : patriarchLeadsRecordUuid.trim();
    }
