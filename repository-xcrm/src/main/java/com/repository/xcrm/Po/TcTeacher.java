 ...
 * @description：老师po
 * @author： denny
 * @create： 2018-03-21 11:42
 **/
public class TcTeacher implements Serializable{
    private static final long serialVersionUID = 1L;
    private Long id;

    private String uuid;

    private Long trainingQuestionNumber;
    ...
    public Long getTrainingQuestionNumber() {
        return trainingQuestionNumber;
    }

    public void setTrainingQuestionNumber(Long trainingQuestionNumber) {
